...
//
//
//   Future<R> _handleError<R>(Function onErrorClosure, Object error, StackTrace stackTrace) {
//     try {
//       dynamic result;
//       if (onErrorClosure is Function(Object, StackTrace)) {
//         result = onErrorClosure(error, stackTrace);
//       } else if (onErrorClosure is Function(Object)) {
//         result = onErrorClosure(error);
//       } else {
//         throw ArgumentError('Invalid onError callback format.');
//       }
//
